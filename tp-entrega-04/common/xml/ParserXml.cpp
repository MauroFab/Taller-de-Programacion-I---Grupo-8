...
//-----------------------------------------------------------------------------
	...
	XMLText * textoMaxCli = xmlDoc.NewText("1");
	...
	//ventana
	XMLElement * pVentana = xmlDoc.NewElement("ventana");	
	XMLElement * pAncho = xmlDoc.NewElement("ancho");
	XMLText * textoAncho = xmlDoc.NewText("480");
	pAncho->InsertEndChild(textoAncho);
	pVentana->InsertEndChild(pAncho);
	XMLElement * pAlto = xmlDoc.NewElement("alto");
	XMLText * textoAlto = xmlDoc.NewText("640");
	pAlto->InsertEndChild(textoAlto);
	pVentana->InsertEndChild(pAlto);
	XMLElement * pVelCam = xmlDoc.NewElement("velocidadCamara");
	XMLText * textoVelCam = xmlDoc.NewText("500");
	pVelCam->InsertEndChild(textoVelCam);
	pVentana->InsertEndChild(pVelCam);
	pRaiz->InsertEndChild(pVentana);

	//sprites
	XMLElement * pTemp = NULL;
	XMLElement * pTemp_1 = NULL;
	XMLElement * pTemp_2 = NULL;
	XMLElement * pTemp_3 = NULL;
	XMLElement * pSprites = xmlDoc.NewElement("sprites");
	XMLElement * pSprite_0 = xmlDoc.NewElement("sprite");
		pTemp = xmlDoc.NewElement("id");
		pTemp->InsertEndChild(xmlDoc.NewText("fondo"));
		pSprite_0->InsertEndChild(pTemp);
		pTemp = xmlDoc.NewElement("path");
		pTemp->InsertEndChild(xmlDoc.NewText("bg.bmp"));
		pSprite_0->InsertEndChild(pTemp);	
		pTemp = xmlDoc.NewElement("cantidad");
		pTemp->InsertEndChild(xmlDoc.NewText("1"));
		pSprite_0->InsertEndChild(pTemp);	
		pTemp = xmlDoc.NewElement("ancho");
		pTemp->InsertEndChild(xmlDoc.NewText("10"));
		pSprite_0->InsertEndChild(pTemp);	
		pTemp = xmlDoc.NewElement("alto");
		pTemp->InsertEndChild(xmlDoc.NewText("12"));
		pSprite_0->InsertEndChild(pTemp);		
	pSprites->InsertEndChild(pSprite_0);
	XMLElement * pSprite_1 = xmlDoc.NewElement("sprite");
		pTemp = xmlDoc.NewElement("id");
		pTemp->InsertEndChild(xmlDoc.NewText("isla"));
		pSprite_1->InsertEndChild(pTemp);
		pTemp = xmlDoc.NewElement("path");
		pTemp->InsertEndChild(xmlDoc.NewText("isla.bmp"));
		pSprite_1->InsertEndChild(pTemp);
		pTemp = xmlDoc.NewElement("cantidad");
		pTemp->InsertEndChild(xmlDoc.NewText("1"));
		pSprite_1->InsertEndChild(pTemp);
		...
		pTemp->InsertEndChild(xmlDoc.NewText("12"));
		pSprite_1->InsertEndChild(pTemp);
	pSprites->InsertEndChild(pSprite_1);
	XMLElement * pSprite_2 = xmlDoc.NewElement("sprite");
		pTemp = xmlDoc.NewElement("id");
		pTemp->InsertEndChild(xmlDoc.NewText("barco"));
		pSprite_2->InsertEndChild(pTemp);
		pTemp = xmlDoc.NewElement("path");
		pTemp->InsertEndChild(xmlDoc.NewText("barco.bmp"));
		pSprite_2->InsertEndChild(pTemp);
		pTemp = xmlDoc.NewElement("cantidad");
		pTemp->InsertEndChild(xmlDoc.NewText("1"));
		pSprite_2->InsertEndChild(pTemp);
		...
		pTemp->InsertEndChild(xmlDoc.NewText("12"));
		pSprite_2->InsertEndChild(pTemp);
	pSprites->InsertEndChild(pSprite_2);
	XMLElement * pSprite_3 = xmlDoc.NewElement("sprite");
		pTemp = xmlDoc.NewElement("id");
		pTemp->InsertEndChild(xmlDoc.NewText("avion_1"));
		pSprite_3->InsertEndChild(pTemp);
		pTemp = xmlDoc.NewElement("path");
		pTemp->InsertEndChild(xmlDoc.NewText("avion_1.bmp"));
		pSprite_3->InsertEndChild(pTemp);
		pTemp = xmlDoc.NewElement("cantidad");
		pTemp->InsertEndChild(xmlDoc.NewText("7"));
		pSprite_3->InsertEndChild(pTemp);
		pTemp = xmlDoc.NewElement("ancho");
		pTemp->InsertEndChild(xmlDoc.NewText("113"));
		pSprite_3->InsertEndChild(pTemp);
		pTemp = xmlDoc.NewElement("alto");
		pTemp->InsertEndChild(xmlDoc.NewText("195"));
		pSprite_3->InsertEndChild(pTemp);
	pSprites->InsertEndChild(pSprite_3);
	XMLElement * pSprite_4 = xmlDoc.NewElement("sprite");
		pTemp = xmlDoc.NewElement("id");
		pTemp->InsertEndChild(xmlDoc.NewText("avion_2"));
		pSprite_4->InsertEndChild(pTemp);
		pTemp = xmlDoc.NewElement("path");
		pTemp->InsertEndChild(xmlDoc.NewText("avion_2.bmp"));
		pSprite_4->InsertEndChild(pTemp);
		pTemp = xmlDoc.NewElement("cantidad");
		pTemp->InsertEndChild(xmlDoc.NewText("7"));
		pSprite_4->InsertEndChild(pTemp);
		pTemp = xmlDoc.NewElement("ancho");
		pTemp->InsertEndChild(xmlDoc.NewText("102"));
		pSprite_4->InsertEndChild(pTemp);
		pTemp = xmlDoc.NewElement("alto");
		pTemp->InsertEndChild(xmlDoc.NewText("195"));
		pSprite_4->InsertEndChild(pTemp);
	pSprites->InsertEndChild(pSprite_4);
	XMLElement * pSprite_5 = xmlDoc.NewElement("sprite");
		pTemp = xmlDoc.NewElement("id");
		pTemp->InsertEndChild(xmlDoc.NewText("avion_3"));
		pSprite_5->InsertEndChild(pTemp);
		pTemp = xmlDoc.NewElement("path");
		pTemp->InsertEndChild(xmlDoc.NewText("avion_3.bmp"));
		pSprite_5->InsertEndChild(pTemp);
		pTemp = xmlDoc.NewElement("cantidad");
		pTemp->InsertEndChild(xmlDoc.NewText("7"));
		pSprite_5->InsertEndChild(pTemp);
		...
		pTemp->InsertEndChild(xmlDoc.NewText("195"));
		pSprite_5->InsertEndChild(pTemp);
	pSprites->InsertEndChild(pSprite_5);
	XMLElement * pSprite_6 = xmlDoc.NewElement("sprite");
		pTemp = xmlDoc.NewElement("id");
		pTemp->InsertEndChild(xmlDoc.NewText("disparo_1"));
		pSprite_6->InsertEndChild(pTemp);
		pTemp = xmlDoc.NewElement("path");
		pTemp->InsertEndChild(xmlDoc.NewText("disparo_1.bmp"));
		pSprite_6->InsertEndChild(pTemp);
		pTemp = xmlDoc.NewElement("cantidad");
		pTemp->InsertEndChild(xmlDoc.NewText("1"));
		pSprite_6->InsertEndChild(pTemp);
		pTemp = xmlDoc.NewElement("ancho");
		pTemp->InsertEndChild(xmlDoc.NewText("11"));
		pSprite_6->InsertEndChild(pTemp);
		pTemp = xmlDoc.NewElement("alto");
		pTemp->InsertEndChild(xmlDoc.NewText("25"));
		pSprite_6->InsertEndChild(pTemp);
	pSprites->InsertEndChild(pSprite_6);
	pRaiz->InsertEndChild(pSprites);

	//escenario
	XMLElement * pEscenario = xmlDoc.NewElement("escenario");
	pTemp = xmlDoc.NewElement("ancho");
	pTemp->InsertEndChild(xmlDoc.NewText("100"));
	pEscenario->InsertEndChild(pTemp);
	pTemp = xmlDoc.NewElement("alto");
	pTemp->InsertEndChild(xmlDoc.NewText("1000"));
	pEscenario->InsertEndChild(pTemp);
	pTemp = xmlDoc.NewElement("fondo");
		pTemp_1 = xmlDoc.NewElement("spriteId");
		pTemp_1->InsertEndChild(xmlDoc.NewText("fondo"));
		pTemp->InsertEndChild(pTemp_1);
		pTemp_1 = xmlDoc.NewElement("ancho");
		pTemp_1->InsertEndChild(xmlDoc.NewText("0"));
		pTemp->InsertEndChild(pTemp_1);
		pTemp_1 = xmlDoc.NewElement("alto");
		pTemp_1->InsertEndChild(xmlDoc.NewText("0"));
		pTemp->InsertEndChild(pTemp_1);
	pEscenario->InsertEndChild(pTemp);
	pTemp = xmlDoc.NewElement("elementos");		
		pTemp_1 = xmlDoc.NewElement("elemento");
			pTemp_2 = xmlDoc.NewElement("spriteId");
			pTemp_2->InsertEndChild(xmlDoc.NewText("isla"));
			pTemp_1->InsertEndChild(pTemp_2);
			pTemp_2 = xmlDoc.NewElement("posicion");
			pTemp_3 = xmlDoc.NewElement("x");
			pTemp_3->InsertEndChild(xmlDoc.NewText("300"));
			pTemp_2->InsertEndChild(pTemp_3);
			pTemp_3 = xmlDoc.NewElement("y");
			pTemp_3->InsertEndChild(xmlDoc.NewText("800"));
			pTemp_2->InsertEndChild(pTemp_3);
			pTemp_1->InsertEndChild(pTemp_2);
		pTemp->InsertEndChild(pTemp_1);
		pTemp_1 = xmlDoc.NewElement("elemento");
			...
			pTemp_2 = xmlDoc.NewElement("posicion");
			pTemp_3 = xmlDoc.NewElement("x");
			pTemp_3->InsertEndChild(xmlDoc.NewText("40"));
			pTemp_2->InsertEndChild(pTemp_3);
			pTemp_3 = xmlDoc.NewElement("y");
			pTemp_3->InsertEndChild(xmlDoc.NewText("450"));
			pTemp_2->InsertEndChild(pTemp_3);
			pTemp_1->InsertEndChild(pTemp_2);
		pTemp->InsertEndChild(pTemp_1);
		pTemp_1 = xmlDoc.NewElement("elemento");
			...
			pTemp_2 = xmlDoc.NewElement("posicion");
			pTemp_3 = xmlDoc.NewElement("x");
			pTemp_3->InsertEndChild(xmlDoc.NewText("50"));
			pTemp_2->InsertEndChild(pTemp_3);
			pTemp_3 = xmlDoc.NewElement("y");
			pTemp_3->InsertEndChild(xmlDoc.NewText("50"));
			pTemp_2->InsertEndChild(pTemp_3);
		...
		pTemp_1 = xmlDoc.NewElement("elemento");
			pTemp_2 = xmlDoc.NewElement("spriteId");
			pTemp_2->InsertEndChild(xmlDoc.NewText("barco"));
			pTemp_1->InsertEndChild(pTemp_2);
			pTemp_2 = xmlDoc.NewElement("posicion");
			pTemp_3 = xmlDoc.NewElement("x");
			pTemp_3->InsertEndChild(xmlDoc.NewText("250"));
			pTemp_2->InsertEndChild(pTemp_3);
			pTemp_3 = xmlDoc.NewElement("y");
			pTemp_3->InsertEndChild(xmlDoc.NewText("250"));
			pTemp_2->InsertEndChild(pTemp_3);
	...
	pRaiz->InsertEndChild(pEscenario);

	//aviones
	XMLElement * pAviones = xmlDoc.NewElement("aviones");
	pTemp = xmlDoc.NewElement("avion");
		pTemp_1 = xmlDoc.NewElement("velocidadDesplazamiento");
		pTemp_1->InsertEndChild(xmlDoc.NewText("10"));
		pTemp->InsertEndChild(pTemp_1);
		pTemp_1 = xmlDoc.NewElement("velocidadDisparos");
		pTemp_1->InsertEndChild(xmlDoc.NewText("3"));
		pTemp->InsertEndChild(pTemp_1);
		pTemp_1 = xmlDoc.NewElement("avionSpriteId");
		pTemp_1->InsertEndChild(xmlDoc.NewText("avion_1"));
		pTemp->InsertEndChild(pTemp_1);
		pTemp_1 = xmlDoc.NewElement("vueltaSpriteId");
		pTemp_1->InsertEndChild(xmlDoc.NewText("avion_1"));
		pTemp->InsertEndChild(pTemp_1);
		pTemp_1 = xmlDoc.NewElement("disparosSpriteId");
		pTemp_1->InsertEndChild(xmlDoc.NewText("disparo_1"));
		pTemp->InsertEndChild(pTemp_1);
	pAviones->InsertEndChild(pTemp);
	pTemp = xmlDoc.NewElement("avion");
		pTemp_1 = xmlDoc.NewElement("velocidadDesplazamiento");
		pTemp_1->InsertEndChild(xmlDoc.NewText("10"));
		pTemp->InsertEndChild(pTemp_1);
		...
		pTemp->InsertEndChild(pTemp_1);
		pTemp_1 = xmlDoc.NewElement("avionSpriteId");
		pTemp_1->InsertEndChild(xmlDoc.NewText("avion_2"));
		pTemp->InsertEndChild(pTemp_1);
		pTemp_1 = xmlDoc.NewElement("vueltaSpriteId");
		pTemp_1->InsertEndChild(xmlDoc.NewText("avion_2"));
		pTemp->InsertEndChild(pTemp_1);
	...
	pTemp = xmlDoc.NewElement("avion");
		...
		pTemp->InsertEndChild(pTemp_1);
		pTemp_1 = xmlDoc.NewElement("avionSpriteId");
		pTemp_1->InsertEndChild(xmlDoc.NewText("avion_3"));
		pTemp->InsertEndChild(pTemp_1);
		pTemp_1 = xmlDoc.NewElement("vueltaSpriteId");
		pTemp_1->InsertEndChild(xmlDoc.NewText("avion_3"));
		pTemp->InsertEndChild(pTemp_1);
	...
	pTemp = xmlDoc.NewElement("avion");
		...
		pTemp->InsertEndChild(pTemp_1);
		pTemp_1 = xmlDoc.NewElement("avionSpriteId");
		pTemp_1->InsertEndChild(xmlDoc.NewText("avion_4"));
		pTemp->InsertEndChild(pTemp_1);
		pTemp_1 = xmlDoc.NewElement("vueltaSpriteId");
		pTemp_1->InsertEndChild(xmlDoc.NewText("avion_4"));
		pTemp->InsertEndChild(pTemp_1);
